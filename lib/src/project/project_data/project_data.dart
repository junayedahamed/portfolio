class ProjectData {
  ProjectData._();
  static const List<String> projectName = [
    "Juna_The_BOT",
    'Music Player',
    "Quiz App",
    "Portfolio",
  ...
  static const List<String> projectDescription = [
    ...
    'A music player app that allows users to play, pause, and skip tracks, with a user-friendly interface and smooth animations.',
  ...
  static const List<String> projectLink = [
    ...
    "https://github.com/junayedahamed/music",
